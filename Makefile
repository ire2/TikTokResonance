...
ui: ; uvicorn profiling.label_ui.app:app --reload --port $(PORT)

dashboard: ; uvicorn resonance.dashboard.app:app --reload --port $(PORT)
dashboard-demo: ; DEMO_MODE=true RESONANCE_CACHE_PATH=data/demo/resonance_cache.json uvicorn resonance.dashboard.app:app --reload --port $(PORT)
