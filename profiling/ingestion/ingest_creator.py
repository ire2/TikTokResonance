...
def ingest_creator(creator_handle: str, video_limit: int = 30):
    ...
    - persist to raw_data/creator_metadata.json
    """

    RAW_DATA_DIR.mkdir(exist_ok=True)

    raw_videos = fetch_raw_videos(creator_handle, video_limit)
...
if __name__ == "__main__":
    ...
    print("Ingestion complete. Metadata updated.")
